var user = {
    ...
    login: function() {
        ...
        xmlhttp.open("POST", this.url+"/login");
    ...
    register: function() {
        ...
        if(password == password_again){
            ...
            var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
            xmlhttp.open("POST", this.url+"/register");
    ...
    logout: function() {
        ...
        var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
        console.log(this.session);
        xmlhttp.open("GET", this.url+"/logout/"+this.session);
        xmlhttp.send();
        xmlhttp.onreadystatechange=function()
        {
    ...
    contactus: function() {
        ...
        var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
        xmlhttp.open("POST", this.url+"/contactus");
    ...
    trusted: function() {
        ...
        var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
        console.log(this.session);
        xmlhttp.open("GET", this.url+"/trusted/"+this.session);
        xmlhttp.send();
        xmlhttp.onreadystatechange=function()
        {
            console.log(xmlhttp.responseText);
    ...
    account: function() {
        ...
        var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
        console.log(this.session);
        xmlhttp.open("GET", this.url+"/account/"+this.session);
        xmlhttp.send();
        xmlhttp.onreadystatechange=function()
        {
            console.log(xmlhttp.responseText);
    ...
    renew: function() {
        ...
        var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
        console.log(this.session);
        xmlhttp.open("GET", this.url+"/renew/"+this.session);
        xmlhttp.send();
        xmlhttp.onreadystatechange=function()
        {
            console.log(xmlhttp.responseText);
...
var Space = function (session){
        ...
        xmlhttp.onreadystatechange=function()
        {
            if ((xmlhttp.status >= 200 && xmlhttp.status <= 300) || xmlhttp.status == 304) {
                ...
                for(var i = 0; i < response["projects"].length; i++){
                    ...
                    content += "<div class=\"card-action valign-wrapper\">";
    ...
    this.pull = function(project_name, record_id) {
        ...
        window.location.replace(url+"/"+this.session+"/record/pull/"+project_name+"/"+record_id);
        // xmlhttp.send();
        // xmlhttp.onreadystatechange=function()
        // {
