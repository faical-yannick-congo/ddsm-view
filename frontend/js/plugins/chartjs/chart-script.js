...
if(parts[0] == "session"){
    ...
    console.log(session);
    xmlhttp.open("GET", "http://localhost:5200/cloud/v1/user/dashboard/"+session);
    xmlhttp.send();
    xmlhttp.onreadystatechange=function()
    {
        ...
        if ((xmlhttp.status >= 200 && xmlhttp.status <= 300) || xmlhttp.status == 304) {
            ...
            var containers_total = response["containers_total"];
            ...
            // console.log("Total Containers:"+containers_total);
